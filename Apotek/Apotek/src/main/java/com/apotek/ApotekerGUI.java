 ...
 */
public class ApotekerGUI extends javax.swing.JFrame {
    private Database db;
    
    /**
     * Creates new form ApotekerGUI
     */
    private void populateTable() {
        DefaultTableModel model = (DefaultTableModel) tblApoteker.getModel();
        model.setRowCount(0); // Mengosongkan tabel
        model.setColumnIdentifiers(new Object[]{"ID Apoteker", "Nama", "Alamat", "Email", "No. Telepon"});
        ...
        try {
            ...
            String query = "SELECT * FROM apoteker";
            ResultSet resultSet = db.statement.executeQuery(query);

            while (resultSet.next()) {
                int id = resultSet.getInt("id_apoteker");
                String nama = resultSet.getString("nama");
                String alamat = resultSet.getString("alamat");
                String email = resultSet.getString("email");
                String nomorTelepon = resultSet.getString("no_telpn");



                model.addRow(new Object[]{id, nama, alamat, email, nomorTelepon});
            }
    ...
    private boolean isIdDuplicate(String id) {
        try {
            ...
            String query = "SELECT * FROM apoteker WHERE id_apoteker = " + id;
            ResultSet resultSet = db.statement.executeQuery(query);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 50, 250, 90));
        ...
        getContentPane().add(txtIDApoteker, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 140, 180, -1));
        ...
        getContentPane().add(txtALAMAT, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 220, 180, -1));
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (id_apoteker.isEmpty() || nama.isEmpty() || alamat.isEmpty() || email.isEmpty() || nomorTelepon.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Semua kolom harus diisi.", "Peringatan", JOptionPane.WARNING_MESSAGE);
            return;
        }
        if (!isInteger(id_apoteker)) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApotekerGUI().setVisible(true);
            }
        });
    }
